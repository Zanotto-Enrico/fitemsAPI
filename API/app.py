...
def index():
	...
	info += "<h4> Passare i parametri che si vole aggiornare scegliendo un insieme tra i seguenti: nome, cognome,latitudine, longitudine (in decimale) facendo un POST alla pagina </h4> /myInfo</br></br>"
